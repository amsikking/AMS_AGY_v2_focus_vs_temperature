...
import thorlabs_TSP01B      # github.com/amsikking/thorlabs_TSP01B
...
temp_logger = thorlabs_TSP01B.Data_Logger(verbose=True)
...
for t in t_steps_C:
    ...
    t1_O2_C = round(temp_logger.get_temperature('TH1'), 1) # thermistor on O2
    # take z stack:
    z_stack = np.zeros(
    ...
    t2_O2_C = round(temp_logger.get_temperature('TH1'), 1)
    # save data:
